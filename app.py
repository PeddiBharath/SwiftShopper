...
from functions import is_valid_email,add_to_cart,remove_from_cart,generate_unique_order_id,check_quantity,check_role,quantity_check
from functions import products_fetch,fetch_product_details,update_or_add_inventory
from functions import fetch_products,fetch_orders,predict_orders
from functions import fetch_orders_data,plot_overall_sales,plot_product_sales
